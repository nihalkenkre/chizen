...
RENDERING_API r_api = RENDERING_API::DX12;
...
LRESULT CALLBACK RendererWndProc(HWND h_wnd, UINT msg, WPARAM w_param, LPARAM l_param)
{
	...
	case WM_CREATE:
		dx12 = CreateWindowA("BUTTON", "DX 12", WS_CHILD | WS_VISIBLE | BS_AUTORADIOBUTTON | WS_GROUP | WS_TABSTOP, 10, 10, 100, 30, h_wnd, (HMENU)DX_12_RADIO_BTN, h_instance, nullptr);
		vk = CreateWindowA("BUTTON", "Vulkan", WS_CHILD | WS_VISIBLE | BS_AUTORADIOBUTTON, 10, 40, 100, 30, h_wnd, (HMENU)VULKAN_RADIO_BTN, h_instance, nullptr);

		Button_SetCheck(dx12, 1);
		break;
